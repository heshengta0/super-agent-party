      ...
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'proxyNotice': '请输入代理地址，例如：http://127.0.0.1:7890',
...
key3`,
        ...
        'start_read': '开始阅读',
        'stop_read': '停止阅读',
        'longTextPlaceholder': '请输入需要被阅读的长文本，配合桌宠机器人可以实现数字人口播功能。你可以使用<音色名></音色名>将使用对应音色括起来，实现多音色朗读。',
        'selectFile': '选择文件',
        ...
        "defaultTTS": "默认语音合成",
        "addNewTTS": "新增语音合成",
        "ttsName": "音色名（可以选择，也可以手动填写，最好为英文！）",
      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'proxyNotice': 'Please enter the proxy address, such as http://127.0.0.1:7890',
...
Key3`,
        ...
        'longTextPlaceholder': 'Please enter a long text that needs to be read, with the table pet robot, the digital population broadcast function can be realized.You can use <timbre name> </timbre name> to enclose the corresponding timbre to achieve multi-timbre reading.',
        ...
        "ttsName": "Sound name (You can choose or fill in manually, preferably in English!)",
