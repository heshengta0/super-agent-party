...
key3`,
        ...
        'start_read': '开始阅读',
        'stop_read': '停止阅读',
        'longTextPlaceholder': '请输入需要被阅读的长文本，配合桌宠机器人可以实现数字人口播功能',
        'selectFile': '选择文件',
...
Key3`,
        ...
        'longTextPlaceholder': 'Please enter a long text that needs to be read, with the table pet robot, the digital population broadcast function can be realized',
