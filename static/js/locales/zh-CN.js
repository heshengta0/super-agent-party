...
key3`,
        ...
        'crwURLPlaceholder': 'https://fastcrw.com/api/v1  或 http://localhost:3000/v1',
        'crwAPIKeyPlaceholder': 'CRW_API_KEY 或自部署的API密钥',
        'crwKeyHint': '使用云端API需要有效的API Key，自部署版本可为空',
        ...
        'pleaseConfigCrwUrl': '联网工具配置不完整，请配置 fastCRW 的 Base URL',
        'pleaseConfigCrwApiKey': '联网工具配置不完整，请配置 fastCRW API Key',
