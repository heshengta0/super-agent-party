...
Key3`,
        ...
        'crwURLPlaceholder': 'https://fastcrw.com/api/v1  or http://localhost:3000/v1',
        'crwAPIKeyPlaceholder': 'CRW_API_KEY or self-hosted API key',
        'crwKeyHint': 'Cloud API requires valid API Key, self-hosted can be empty',
        ...
        'pleaseConfigCrwUrl': 'Web Search tool configuration is incomplete, Please configure fastCRW Base URL',
        'pleaseConfigCrwApiKey': 'Web Search tool configuration is incomplete, Please configure fastCRW API Key',
